    ...
    return Scaffold(
      ...
      body: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
        ...
        builder: (context, snap) {
          ...
          final recipes = snap.data!.docs.map((d) => Recipe.fromFirestore(d)).toList();
          if (recipes.isEmpty) return const Center(child: Text('No public recipes'));
          return ListView.separated(
            ...
            itemBuilder: (context, i) => RecipeCard(
              recipe: recipes[i],
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (_) => ViewRecipePage(recipe: recipes[i]))),
            ),
          );
        },
      ),
